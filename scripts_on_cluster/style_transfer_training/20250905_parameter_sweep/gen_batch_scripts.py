...
campaign_dir = Path("/home/sibwang/biomechpose/scripts_on_cluster/style_transfer_training/20250905_parameter_sweep")
data_output_dir = Path("/scratch/sibwang/biomechpose/bulk_data/style_transfer/20250905_parameter_sweep/")
