...
campaign_dir = Path(f"/home/{username}/poseforge/scripts_on_cluster/style_transfer_training/20250905_continued_training/")
data_output_dir = Path(f"/scratch/{username}/poseforge/bulk_data/style_transfer/20250905_continued_training/")
