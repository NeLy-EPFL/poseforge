...
from biomechpose.pose_estimation import visualize_latent_trajectory
...
if __name__ == "__main__":
    ...
    training_stages = ["epoch000_step000000"] + [
        f"epoch{epoch:03d}_step003000" for epoch in range(10)
    ]
