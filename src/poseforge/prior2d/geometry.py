...
Used by `scripts/port_slp_labels.py` (raw camera domain -> aligned domain)
and `scripts/select_continuous_periods.py` (aligned domain -> raw camera
domain, for the physical mm conversion).
"""
