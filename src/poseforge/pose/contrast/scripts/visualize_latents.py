...
if __name__ == "__main__":
    inference_output_basedir = Path(
        "/mnt/upramdya_data/VAS/poseforge/poseforge_contrastive/trial_20260504_tiledlowlr_b32/inference/"
    )
    ...
    # ]
    example_sims = [
        "BO_Gal4_fly2_trial005/segment_001/subsegment_000", # grooming clip
        "BO_Gal4_fly2_trial005/segment_000/subsegment_000", # walk and turn clip
    ]

    training_stages = ["untrained", "epoch001_step000500", "epoch003_step000500",
                       "epoch005_step000500", "epoch007_step000500", "epoch009_step000500"]
