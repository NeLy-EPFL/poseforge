...
if __name__ == "__main__":
    ...
    # python src/poseforge/pose_estimation/keypoints3d/scripts/run_inverse_kinematics.py --input-dirs bulk_data/pose_estimation/keypoints3d/trial_20251013b/production/epoch28/20250613-fly1b-013/ --max-n-frames 50 --create-visualization --input-images-basedir bulk_data/behavior_images/spotlight_aligned_and_cropped/
