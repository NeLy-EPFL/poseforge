...
if __name__ == "__main__":
    ...
    nmf_rendering_dir = Path("/work/upramdya/stimpfli/poseforge/data/nmf_rendering")
    # Recorded images (from Spotlight)
    spotlight_recordings_dir = Path(
        "/work/upramdya/stimpfli/poseforge/data/spotlight_aligned_and_cropped"
    )
    # Output directory for extracted training images
    output_dir = Path(
        "/work/upramdya/stimpfli/poseforge/style_transfer_datasets/nmf/aymanns2022_pseudocolor_spotlight_dataset_gray"
    )
