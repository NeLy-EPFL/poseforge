...
if __name__ == "__main__":
    ...
    nmf_rendering_dir = Path("/scratch/stimpfli/bulk_data_flybody")
    # Recorded images (from Spotlight)
    spotlight_recordings_dir = Path(
        "/scratch/stimpfli/behavior_images/spotlight_aligned_and_cropped"
    )
    # Output directory for extracted training images
    output_dir = Path(
        "/home/stimpfli/aymanns2022_pseudocolor_spotlight_dataset_flybody_link"
    )
    video_filename = "processed_nmf_sim_render_per_link_color.mp4"
